...
//import the axios 
// import axios from 
export default class PostingPage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      location: "",
  ...
  handleSubmit = (event) => {
    ...
    const { gender, age, minAge, price, duration, selectedCategories, date, time } = this.state;

    let isValid = true;
    if (!gender || !age || (age === "Required" && (!minAge || minAge < 18)) || selectedCategories.length === 0) {
      isValid = false;
    }
  ...
  toggleCategory = (category) => {
    this.setState((prevState) => {
      ...
      if (selectedCategories.includes(category)) {
        return { selectedCategories: selectedCategories.filter((cat) => cat !== category) };
      } else {
  ...
  render() {
    ...
    const categories = ["Child Care", "Babysitting", "Plumbing", "Gardening", "Painting"];
            ...
            <Form noValidate validated={validated} onSubmit={this.handleSubmit}>
                  ...
                  <Form.Group>
                    ...
                    <div className="d-flex gap-4 mt-2">
                      <Form.Check
                        ...
                        name="durationType"
                        value="Open"
                        onChange={(e) => this.setState({ durationType: e.target.value, endTime: "", endDate: "" })}
                      ...
                      <Form.Check
                        ...
                        name="durationType"
                        value="Closed"
                        onChange={(e) => this.setState({ durationType: e.target.value })}
              ...
              <div className="mb-3">
                  ...
                  {categories.map((category, index) => (
                    <div
                      ...
                      className={`badge px-3 py-2 ${
                        selectedCategories.includes(category) ? "bg-info text-white" : "bg-light text-dark"
                      }`}
                      style={{
                        backgroundColor: selectedCategories.includes(category) ? "#17a2b8" : "#d3d3d3",
                        borderRadius: "30px",
                        cursor: "pointer",
                      }}
                ...
                {validated && selectedCategories.length === 0 && (
                  <div className="invalid-feedback d-block">Please select at least one category.</div>
                )}
              </div>
            ...
            Please select the difficulty level .
              ...
              <Form.Group className="mt-2">
                ...
                <Form.Control
                  ...
                  value="jobDetails"
                  onChange={(e) => this.setState({jobDetails : e.target.value })}
                />
              </Form.Group>
  ...
  <Form.Group className="mb-3">
    ...
    <div className="mb-3, d-flex align-items-center gap-3" >
      <Form.Label style={{ fontWeight: "bold" }} className="me-3 mt-1">
        Age:
      </Form.Label>
    ...
    {/* Gender Selection */}
    <div className="mb-3 , d-flex align-items-center gap-3">
      <Form.Label className="mt-3" style={{ fontWeight: "bold" }}>Gender:</Form.Label>
      <div className="d-flex gap-4 mt-2">
        <Form.Check
          type="radio"
          label="Female"
    ...
    {validated && !gender && (
        ...
        <Form.Group className="mt-0">
                ...
                <Form.Control
                  ...
                  onChange={(e) => this.setState({ otherRequirements: e.target.value })}
                />
              </Form.Group>
    {/* Submit Button */}
    <div className=" mt-4">
