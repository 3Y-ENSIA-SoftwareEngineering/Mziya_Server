...
app.get('/user', async (req, res) => {
  const user= {'id':'7486c5fa-3dd4-4dcf-88c7-db7180d6c6fa'} // Assume user is authenticated with some middleware
...
app.listen(3000, () => console.log('Server running here progilr on port 3000'));
