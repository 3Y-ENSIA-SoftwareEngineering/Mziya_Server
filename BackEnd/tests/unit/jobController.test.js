import request from 'supertest'; // used to send http request to test api endpoint
...
describe('Job Posting API', () => {
    ...
    // run setup code before running any test in the suite
    beforeAll(async () => {
    ...
    describe('Successful Job Posting', () => {
        it('should create a new job with valid data', async () => {
            ...
            // Additional checks on the returned job
